...
*/
/******************************************************************************/
void Mtx44::SetToLookAt(double eyeX, double eyeY, double eyeZ, //position
				double centerX, double centerY, double centerZ, //target
				double upX, double upY, double upZ) {

	Vector3 f((float)(centerX - eyeX), (float)(centerY - eyeY), (float)(centerZ - eyeZ)); //view
	f.Normalize();
	Vector3 up((float)upX, (float)upY, (float)upZ); //up
	up.Normalize();
